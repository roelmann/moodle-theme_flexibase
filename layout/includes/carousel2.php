    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
		...
		if (theme_flexibase_get_setting('slide' . $carouselslide . 'image')) {
			$slideimage = $PAGE->theme->setting_file_url('slide' . $carouselslide . 'image', 'slide' . $carouselslide . 'image');
		}
        ...
        <div class="item <?php echo $active;?>">
          ...
          <div class="container">
            <div class="carousel-caption">
              ...
              <p><a class="btn btn-lg btn-primary" href="#" role="button"><?php echo get_string('readmore', 'theme_flexibase')?></a></p>
            </div>
          </div>
        </div>
