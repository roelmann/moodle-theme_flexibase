YUI.add('moodle-theme_flexibase-awesomebar', function(Y) {
...
Y.extend(AwesomeBar, Y.Base, AwesomeBar.prototype, {
    NAME : 'flexibase theme AwesomeBar enhancer',
    ATTRS : {
        // No attributes at present
    }
});
// Our splash theme namespace
M.theme_flexibase = M.theme_flexibase || {};
// Initialisation function for the AwesomeBar enhancer
M.theme_flexibase.initAwesomeBar = function(cfg) {
